 ...
 * https://codelabs.developers.google.com/codelabs/android-network-manager/index.html?index=..%2F..%2Findex#9
 *
 * ref https://github.com/filipproch/gcmnetworkmanager-android-example
 * ref http://jacktech24.logdown.com/posts/292141-working-with-gcmnetworkmanager-on
 */
public class TestNetworkManager extends AppCompatActivity {
    ...
    private class LoadTask extends AsyncTask<Void, Void, List<TaskItem>> {
        ...
        protected List<TaskItem> doInBackground(Void... voids) {
            return TrackUtil.getTaskItemsFromFile(mContext);
        }
    ...
    private class AddTask extends AsyncTask<TaskItem, Void, TaskItem> {
        ...
        protected TaskItem doInBackground(TaskItem... taskItems) {
            ...
            TrackUtil.addTaskItemToFile(mContext, taskItem);
            return taskItem;
        }
        ...
        protected void onPostExecute(TaskItem taskItem) {
            ...
            if (taskItem.getmType().equals(TaskItem.ONEOFF_TASK)) {
                Bundle bundle = new Bundle();
                bundle.putString(TrackUtil.TASK_ID, taskItem.getmId());

                // Schedule oneoff task.
                OneoffTask oneoffTask = new OneoffTask.Builder()
                        .setService(BestTimeService.class)
                        .setTag(taskItem.getmId())
                ...
                Intent nowIntent = new Intent(mContext, NewIntentService.class);
                nowIntent.putExtra(TrackUtil.TASK_ID, taskItem.getmId());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tes_network);
        ...
        mBroadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                String status = intent.getStringExtra(TrackUtil.TASK_STATUS);
    ...
    public void onResume() {
        super.onResume();
        mLocalBroadcastManager.registerReceiver(mBroadcastReceiver, new IntentFilter(TrackUtil.TASK_UPDATE_FILTER));
