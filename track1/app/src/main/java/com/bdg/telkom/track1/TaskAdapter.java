...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.ViewHolder>{
    ...
    private class DeleteTask extends AsyncTask<TaskItem, Void, Integer> {
        ...
        protected Integer doInBackground(TaskItem... taskItems) {
            ...
            TrackUtil.deleteTaskItemFromFile(mContext, taskItems[0]);
            return getTaskItemPosition(taskItem.getmId());
        }
    ...
    public void onBindViewHolder(TaskAdapter.ViewHolder holder, final int position) {
        ...
        holder.getLabelTextView().setText(taskItem.getmType());
        holder.getStatusTextView().setText(taskItem.getmStatus());
    }
